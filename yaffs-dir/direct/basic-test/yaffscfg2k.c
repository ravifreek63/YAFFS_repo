...
{
	printf ("yaffscfg2k.c  ----  IN YAFFS_START_UP ----------\n");
...
//	m18_1Dev.param.disable_soft_del = 1;
	...
	flashDev.param.n_caches = 0; // Use caches
