...
unsigned int ctransaction_id;
void set_transaction_id (unsigned int t_id);
int result_log (char *str);
int result_log_const (const char *str);
void log_output (char *str);
void log_const (const char *str);

enum ROLLBACK_TYPE
{
  EXT4_JOURNAL, YAFFS_COW
};
...
int yaffs_write(int fd, const void *buf, unsigned int nbyte, unsigned int transaction_id) ;

int yaffs_pread(int fd, void *buf, unsigned int nbyte, unsigned int offset);
int yaffs_pwrite(int fd, const void *buf, unsigned int nbyte, unsigned int offset, unsigned int transaction_id);
